...
if "last_keyword" not in st.session_state:
    st.session_state.last_keyword = "KOSPI200"
...
st.caption(f"선택 종목: {selected_item['label']} / Yahoo 코드: `{ticker}`")
...
if data.empty:
    st.error("데이터를 가져오지 못했습니다. 다른 종목을 검색해보세요.")
    st.stop()
